...
lazy val lang =
  crossProject(JSPlatform, JVMPlatform)
    ...
    .jvmSettings(
      ...
      organization := "com.wavesplatform",
      organizationName := "FLG FLGNetwork",
      organizationHomepage := Some(url("https://blackturtle.eu")),
      scmInfo := Some(ScmInfo(url("https://github.com/FLG123/FLGNetwork"), "git@github.com:FLG123/FLGNetwork.git", None)),
      developers := List(Developer("MrFLG", "Bram N.", "info@blackturtle.eu", url("https://blackturtle.eur"))),
