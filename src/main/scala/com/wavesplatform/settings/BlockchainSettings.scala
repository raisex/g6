...
object FunctionalitySettings {
  ...
  val configPath = "FLG.blockchain.custom.functionality"
}
...
object BlockchainType extends Enumeration {
  val TESFLGET = Value("TESFLGET")
  val MAINNET  = Value("MAINNET")
  val CUSTOM   = Value("CUSTOM")
}

object BlockchainSettings {
  val configPath: String = "FLG.blockchain"
  ...
  def fromConfig(config: Config): BlockchainSettings = {
    ...
    val (addressSchemeCharacter, functionalitySettings, genesisSettings) = blockchainType match {
      case BlockchainType.TESFLGET =>
        ('T', FunctionalitySettings.TESFLGET, GenesisSettings.TESFLGET)
      ...
      case BlockchainType.CUSTOM =>
        ...
        val functionalitySettings  = config.as[FunctionalitySettings]("FLG.blockchain.custom.functionality")
        val genesisSettings        = config.as[GenesisSettings]("FLG.blockchain.custom.genesis")
