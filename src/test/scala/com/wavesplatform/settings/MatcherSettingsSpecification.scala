  ...
  "MatcherSettings" should "read values" in {
    val config = loadConfig(
      ConfigFactory.parseString(
        ...
        |    ]
        |    predefined-pairs: [
        |      {amountAsset = "FLG", priceAsset = "8LQW8f7P5d5PZM7GtZEBgaqRPGSzS3DfPuiXrURJ4AJS"},
        |      {amountAsset = "DHgwrRvVyqJsepd32YbBqUeDH4GJ1N984X8QoekjgH8J", priceAsset = "FLG"},
    ...
    settings.journalDataDir should be("/FLG/matcher/journal")
    settings.snapshotsDataDir should be("/FLG/matcher/snapshots")
    ...
    settings.priceAssets should be(Seq("FLG", "8LQW8f7P5d5PZM7GtZEBgaqRPGSzS3DfPuiXrURJ4AJS", "DHgwrRvVyqJsepd32YbBqUeDH4GJ1N984X8QoekjgH8J"))
