    ...
    val tx =
      TransferTransactionV2
        .selfSigned(
          ...
          recipient = acc0,
          amount = 3 * transferAmount + 3 * (0.00001.FLG + 0.00002.FLG), // Script fee
    ...
    val tx =
      TransferTransactionV2
        .selfSigned(
          ...
          timestamp = System.currentTimeMillis(),
          feeAssetId = None,
          feeAmount = minFee + 0.00001.FLG + 0.00002.FLG,
          attachment = Array.emptyByteArray
        )
        .explicitGet()
