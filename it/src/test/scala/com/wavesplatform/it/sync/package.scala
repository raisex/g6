...
package object sync {
  val smartFee                   = 0.06.FLG
  val minFee                        = 0.02.FLG
  val leasingFee                 = 0.02.FLG
  val issueFee                   = 1000.FLG
  val burnFee                    = 10.FLG
  val sponsorFee                 = 10.FLG
  val setAssetScriptFee          = 10.FLG
  val setScriptFee               = 0.04.FLG
  val transferAmount             = 10.FLG
  val leasingAmount              = transferAmount
  val issueAmount                = transferAmount
  val massTransferFeePerTransfer = 0.005.FLG
  val someAssetAmount            = 9999999999999L
  val matcherFee                 = 0.04.FLG
  val orderFee                   = matcherFee
  val smartMatcherFee            = 0.06.FLG
